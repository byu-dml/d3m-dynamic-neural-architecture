...
class HiddenDAGLSTMRegressionModel(DAGLSTMRegressionModel):
    ...
    def __init__(
        ...
        use_batch_norm: bool, loss_function_name: str, use_skip: bool = False, reduction_name: str = 'mean', *,
        device: str = 'cuda:0', seed: int = 0
    ):
        super().__init__(
            activation_name, hidden_state_size, lstm_n_layers, dropout, output_n_hidden_layers,
            output_hidden_layer_size, use_batch_norm, loss_function_name, use_skip, reduction_name, device=device,
            seed=seed
        )
